...
import AdminStakingProducts from "@/components/admin/staking-products";
import AdminWheelSpins from "@/components/admin/wheel-spins";
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <div className="overflow-x-auto -mx-4 px-4">
            <TabsList className="w-max">
              ...
              <TabsTrigger value="wheel" data-testid="tab-wheel">Roue de Chance</TabsTrigger>
              <TabsTrigger value="avis" data-testid="tab-avis">Avis</TabsTrigger>

          ...
          members.map((member) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                >
                  {t("accountLabel")} : {maskPhone(member.phone)}
                </p>
                <p className="text-xs text-gray-400 mt-0.5">
                  {t("dateLabel")} : {formatDate(member.createdAt)}
                </p>
              </div>

...
import { Plus, Edit, Trash2, Phone, Loader2, Eye, EyeOff, Globe } from "lucide-react";
        ...
        Object.entries(grouped).map(([country, nums]) => (
          <div key={country}>
            <div className="flex items-center gap-2 mb-2">
              <span className="text-lg">{COUNTRY_FLAGS[country] || <Globe className="w-5 h-5 inline text-gray-400" />}</span>
